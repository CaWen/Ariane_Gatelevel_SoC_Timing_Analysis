...
primitive seq000 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module CLKGATETST_X1 (CK, E, SE, GCK);
  ...
  and(GCK, IQ, CK);
  seq000(IQ, nextstate, CK, NOTIFIER);
  not(IQn, IQ);
  or(nextstate, E, SE);
...
primitive seq001 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module CLKGATETST_X2 (CK, E, SE, GCK);
  ...
  and(GCK, IQ, CK);
  seq001(IQ, nextstate, CK, NOTIFIER);
  not(IQn, IQ);
  or(nextstate, E, SE);
...
primitive seq002 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module CLKGATETST_X4 (CK, E, SE, GCK);
  ...
  and(GCK, IQ, CK);
  seq002(IQ, nextstate, CK, NOTIFIER);
  not(IQn, IQ);
  or(nextstate, E, SE);
...
primitive seq003 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module CLKGATETST_X8 (CK, E, SE, GCK);
  ...
  and(GCK, IQ, CK);
  seq003(IQ, nextstate, CK, NOTIFIER);
  not(IQn, IQ);
  or(nextstate, E, SE);
...
primitive seq004 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module CLKGATE_X1 (CK, E, GCK);
  ...
  and(GCK, CK, IQ);
  seq004(IQ, nextstate, CK, NOTIFIER);
  not(IQn, IQ);
  buf(nextstate, E);
...
primitive seq005 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module CLKGATE_X2 (CK, E, GCK);
  ...
  and(GCK, CK, IQ);
  seq005(IQ, nextstate, CK, NOTIFIER);
  not(IQn, IQ);
  buf(nextstate, E);
...
primitive seq006 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module CLKGATE_X4 (CK, E, GCK);
  ...
  and(GCK, CK, IQ);
  seq006(IQ, nextstate, CK, NOTIFIER);
  not(IQn, IQ);
  buf(nextstate, E);
...
primitive seq007 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module CLKGATE_X8 (CK, E, GCK);
  ...
  and(GCK, CK, IQ);
  seq007(IQ, nextstate, CK, NOTIFIER);
  not(IQn, IQ);
  buf(nextstate, E);
...
primitive seq008 (IQ, SN, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input RN;
  input nextstate;
...
module DFFRS_X1 (CK, D, RN, SN, Q, QN);
  ...
  seq008(IQ, SN, RN, nextstate, CK, NOTIFIER);
  and(IQN, i_15, i_16);
  not(i_15, IQ);
  not(i_16, i_17);
  and(i_17, i_18, i_19);
...
primitive seq009 (IQ, SN, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input RN;
  input nextstate;
...
module DFFRS_X2 (CK, D, RN, SN, Q, QN);
  ...
  seq009(IQ, SN, RN, nextstate, CK, NOTIFIER);
  and(IQN, i_15, i_16);
  not(i_15, IQ);
  not(i_16, i_17);
  and(i_17, i_18, i_19);
...
primitive seq010 (IQ, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input RN;
  input nextstate;
  input CK;
...
module DFFR_X1 (CK, D, RN, Q, QN);
  ...
  seq010(IQ, RN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  buf(nextstate, D);
...
primitive seq011 (IQ, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input RN;
  input nextstate;
  input CK;
...
module DFFR_X2 (CK, D, RN, Q, QN);
  ...
  seq011(IQ, RN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  buf(nextstate, D);
...
primitive seq012 (IQ, SN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input nextstate;
  input CK;
...
module DFFS_X1 (CK, D, SN, Q, QN);
  ...
  seq012(IQ, SN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  buf(nextstate, D);
...
primitive seq013 (IQ, SN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input nextstate;
  input CK;
...
module DFFS_X2 (CK, D, SN, Q, QN);
  ...
  seq013(IQ, SN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  buf(nextstate, D);
...
primitive seq014 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module DFF_X1 (CK, D, Q, QN);
  ...
  seq014(IQ, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  buf(nextstate, D);
...
primitive seq015 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module DFF_X2 (CK, D, Q, QN);
  ...
  seq015(IQ, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  buf(nextstate, D);
...
primitive seq016 (IQ, nextstate, G, NOTIFIER);
  output IQ;
  input nextstate;
  input G;
  input NOTIFIER;
...
module DLH_X1 (D, G, Q);
  ...
  seq016(IQ, nextstate, G, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(nextstate, D);
...
primitive seq018 (IQ, nextstate, G, NOTIFIER);
  output IQ;
  input nextstate;
  input G;
  input NOTIFIER;
...
module DLH_X2 (D, G, Q);
  ...
  seq018(IQ, nextstate, G, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(nextstate, D);
...
primitive seq019 (IQ, nextstate, GN, NOTIFIER);
  output IQ;
  input nextstate;
  input GN;
  input NOTIFIER;
...
module DLL_X1 (D, GN, Q);
  ...
  seq019(IQ, nextstate, GN, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(nextstate, D);
...
primitive seq020 (IQ, nextstate, GN, NOTIFIER);
  output IQ;
  input nextstate;
  input GN;
  input NOTIFIER;
...
module DLL_X2 (D, GN, Q);
  ...
  seq020(IQ, nextstate, GN, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(nextstate, D);
...
primitive seq021 (IQ, SN, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input RN;
  input nextstate;
...
module SDFFRS_X1 (CK, D, RN, SE, SI, SN, Q, QN);
  ...
  seq021(IQ, SN, RN, nextstate, CK, NOTIFIER);
  and(IQN, i_33, i_34);
  not(i_33, IQ);
  not(i_34, i_35);
  and(i_35, i_36, i_37);
...
primitive seq022 (IQ, SN, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input RN;
  input nextstate;
...
module SDFFRS_X2 (CK, D, RN, SE, SI, SN, Q, QN);
  ...
  seq022(IQ, SN, RN, nextstate, CK, NOTIFIER);
  and(IQN, i_33, i_34);
  not(i_33, IQ);
  not(i_34, i_35);
  and(i_35, i_36, i_37);
...
primitive seq023 (IQ, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input RN;
  input nextstate;
  input CK;
...
module SDFFR_X1 (CK, D, RN, SE, SI, Q, QN);
  ...
  seq023(IQ, RN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
...
primitive seq024 (IQ, RN, nextstate, CK, NOTIFIER);
  output IQ;
  input RN;
  input nextstate;
  input CK;
...
module SDFFR_X2 (CK, D, RN, SE, SI, Q, QN);
  ...
  seq024(IQ, RN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  or(nextstate, i_18, i_19);
...
primitive seq025 (IQ, SN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input nextstate;
  input CK;
...
module SDFFS_X1 (CK, D, SE, SI, SN, Q, QN);
  ...
  seq025(IQ, SN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  or(nextstate, i_18, i_19);
...
primitive seq026 (IQ, SN, nextstate, CK, NOTIFIER);
  output IQ;
  input SN;
  input nextstate;
  input CK;
...
module SDFFS_X2 (CK, D, SE, SI, SN, Q, QN);
  ...
  seq026(IQ, SN, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  or(nextstate, i_18, i_19);
...
primitive seq027 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module SDFF_X1 (CK, D, SE, SI, Q, QN);
  ...
  seq027(IQ, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  or(nextstate, i_18, i_19);
...
primitive seq028 (IQ, nextstate, CK, NOTIFIER);
  output IQ;
  input nextstate;
  input CK;
  input NOTIFIER;
...
module SDFF_X2 (CK, D, SE, SI, Q, QN);
  ...
  seq028(IQ, nextstate, CK, NOTIFIER);
  not(IQN, IQ);
  buf(Q, IQ);
  buf(QN, IQN);
  or(nextstate, i_18, i_19);
...
primitive seq029 (IQ, nextstate, G, NOTIFIER);
  output IQ;
  input nextstate;
  input G;
  input NOTIFIER;
...
module TLAT_X1 (D, G, OE, Q);
  ...
  not(Q_enable, OE);
  seq029(IQ, nextstate, G, NOTIFIER);
  not(IQN, IQ);
  buf(Q_in, IQ);
  buf(nextstate, D);
